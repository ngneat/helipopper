...
// import { HELIPOPPER_CONFIG, HelipopperConfig, InstanceWithClose, NgChanges, Variation } from './helipopper.types';
...
//
//   @Input()
//   popperAppendTo: string | HTMLElement = this.initialOptions.appendTo;
//
//   @Input()
//   popperTrigger: 'mouseenter' | 'focus' | 'click' | 'focusin' | 'manual' | string | undefined;
//
//   @Input()
//   popperMaxWidth: 'none' | number;
//
//   @Input()
//   popperAllowClose: boolean = this.initialOptions.allowClose;
//
//   @Input()
//   popperClassName: string | undefined;
//
//   @Input()
//   popperOffset: [number, number] | undefined;
//
//   @Input('popperInjector')
...
//     } else {
//       this.hide();
//       this.setProps({ trigger: this.popperTrigger });
//     }
//   }
//
//   @Input('helipopper') content: Content;
//
//   @Output() popperClose = new Subject();
//   @Output() popperVisible = new Subject<boolean>();
//
...
//   }
//
//   ngOnChanges(changes: NgChanges<HelipopperDirective>) {
...
//     return coerceElement(this.popperTriggerTarget) || this.host.nativeElement;
//   }
//
//   private get _tooltipHost(): HTMLElement {
//     return coerceElement(this.popperHost) || this.host.nativeElement;
//   }
//
...
//     }
//
//     this.popperTrigger = this.resolveTrigger();
//
...
//       maxWidth: this.popperMaxWidth,
//       hideOnClick: this.popperAllowClose,
//       onCreate: instance => {
//         this.popperClassName && addClass(instance.popper, this.popperClassName);
//       },
//       onShow: instance => {
//         this.zone.run(() => this.instance.setContent(this.resolveContent()));
//         // this.popperAllowClose && this.isPopper && this.addCloseButton(instance as InstanceWithClose);
//         this.popperVisible.next(true);
//       },
//       onHidden: instance => {
//         // this.popperAllowClose && this.isPopper && this.removeCloseButton(instance as InstanceWithClose);
//         this.destroyView();
//         this.popperClose.next();
//         this.popperVisible.next(false);
//       },
//       ...this.resolveTheme(),
//       ...this.tippyOptions
//     });
...
//     return this.popperTrigger || (this.isTooltip ? 'mouseenter' : 'click');
//   }
//
...
//
//     if(isString(this.popperAppendTo)) {
//       containerElement = closest(this.host.nativeElement, this.popperAppendTo);
//     } else {
//       containerElement = this.popperAppendTo;
//     }
//
